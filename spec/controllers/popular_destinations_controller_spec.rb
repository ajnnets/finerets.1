...
RSpec.describe PopularDestinationsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested popular_destination as @popular_destination" do
      popular_destination = PopularDestination.create! valid_attributes
      get :show, params: {id: popular_destination.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested popular_destination as @popular_destination" do
      popular_destination = PopularDestination.create! valid_attributes
      get :edit, params: {id: popular_destination.to_param}, session: valid_session
      expect(assigns(:popular_destination)).to eq(popular_destination)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new PopularDestination" do
        expect {
          post :create, params: {popular_destination: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved popular_destination as @popular_destination" do
        post :create, params: {popular_destination: invalid_attributes}, session: valid_session
        expect(assigns(:popular_destination)).to be_a_new(PopularDestination)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested popular_destination" do
        popular_destination = PopularDestination.create! valid_attributes
        put :update, params: {id: popular_destination.to_param, popular_destination: new_attributes}, session: valid_session
      ...
      it "assigns the requested popular_destination as @popular_destination" do
        popular_destination = PopularDestination.create! valid_attributes
        put :update, params: {id: popular_destination.to_param, popular_destination: valid_attributes}, session: valid_session
        expect(assigns(:popular_destination)).to eq(popular_destination)
      end
    ...
    context "with invalid params" do
      it "assigns the popular_destination as @popular_destination" do
        popular_destination = PopularDestination.create! valid_attributes
        put :update, params: {id: popular_destination.to_param, popular_destination: invalid_attributes}, session: valid_session
        expect(assigns(:popular_destination)).to eq(popular_destination)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested popular_destination" do
      popular_destination = PopularDestination.create! valid_attributes
      expect {
        delete :destroy, params: {id: popular_destination.to_param}, session: valid_session
      }.to change(PopularDestination, :count).by(-1)
    end
